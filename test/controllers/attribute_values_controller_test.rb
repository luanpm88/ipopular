...
class AttributeValuesControllerTest < ActionController::TestCase
  ...
  test "should create attribute_value" do
    assert_difference('AttributeValue.count') do
      post :create, attribute_value: { article_id: @attribute_value.article_id, attribute_id: @attribute_value.attribute_id, raw_value: @attribute_value.raw_value, value: @attribute_value.value }
    end
  ...
  test "should update attribute_value" do
    patch :update, id: @attribute_value, attribute_value: { article_id: @attribute_value.article_id, attribute_id: @attribute_value.attribute_id, raw_value: @attribute_value.raw_value, value: @attribute_value.value }
    assert_redirected_to attribute_value_path(assigns(:attribute_value))
  end
